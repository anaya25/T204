...
def askPlayerName():
    ...
    nameWindow  = Tk()
    nameWindow.title("Tambola Family")
    ...
    bg = ImageTk.PhotoImage(file = "./assets/background.jpeg")

    canvas1 = Canvas( nameWindow, width = 500,height = 500)
    canvas1.pack(fill = "both", expand = True)
    # Display image
    canvas1.create_image( 0, 0, image = bg, anchor = "nw")
    canvas1.create_text( screen_width/4.5, screen_height/8, text = "Enter Name", font=("Chalkboard SE",100), fill="black")
